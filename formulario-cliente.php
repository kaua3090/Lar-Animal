...
<body>
    ...
    <div class="parent">
        <div class="div1">
            <div class="container">
                <figure class="avatar">
                    ...
                    <img src="./imagens/formulario/adote.png" alt="" class="img2">
                    <img src="./imagens/formulario/cadastreLinhaCliente2.png" alt="" class="img4">
                    <img src="./imagens/formulario/animais-1.png" alt="" class="img5">
                </figure>
            </div>
        </div>
        ...
        <div class="div2">
            <div class="conteudo">
                <form name="cadastro" method="POST" enctype="multipart/form-data" action="cadastro-cliente.php" class="formulario" id="form" name="form">
                    <h1 class="title">Area de cadastro: <u style="color: #418997;">Cliente</u></h1>

                    <center>
                        <div class="cx1 cxNome">
                            <label>Nome
                                <span title="Esse campo é obrigatório!" style=color:red;>*</span>
                            </label>
                            <input required type="text" name="txtNome" id="txtNome" placeholder="Nome Completo">
                        </div>
                        ...
                        <div class="cx2">
                            ...
                            <input type="text" name="txtCpf" id="txtCpf" class="field" required onblur="Cpf()">
                        </div>
                        ...
                        <div class="cx3">
                            ...
                            <input type="text" name="txtRg" id="txtRg" required onblur="Rg()">
                        </div>
                        ...
                        <div class="cx4">
                            <label>E-mail
                                <span title="Esse campo é oobrigatório!" style=color:red;>*</span>
                            </label>
                        ...
                        <div class="cx7">
                            ...
                            <input type="text" name="txtSenha2" id="txtConfirmarSenha"  required >
                        </div>
